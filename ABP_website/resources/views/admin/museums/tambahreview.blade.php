        ...
        <div class="row py-5">
            <div class="col">
              ...
              <div class="card-header">
                <center><h3 class="card-title">New Museum</h3></center>
              </div>
              <form action="/insertdata" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="name" name="nama_tempat" class="form-control" id="nama" placeholder="nama museum">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="Location" class="form-control" id="lok" placeholder="Masukan Lokasi">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="open_hours" class="form-control" id="jam" placeholder="input jam">
                  </div>
                </div>
